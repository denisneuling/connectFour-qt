...
GameBoardRenderer::GameBoardRenderer(int width, int height, float cellSize, Design design) :
    ConnectFourRenderObject(width, height, cellSize, design), m_Player(RED)
{
}
